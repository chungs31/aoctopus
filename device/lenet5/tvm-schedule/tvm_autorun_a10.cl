...
__kernel void fused_nn_dense_relu_1_kernel0(__global float* restrict placeholder1, __global float* restrict placeholder2) {
  ...
  for (int ax1 = 0; ax1 < 120; ++ax1) {
    ...
    for (int k_outer = 0; k_outer < 100; ++k_outer) {
      T_dense[(0)] = (T_dense[(0)] + (in[((k_outer * 4))] * placeholder1[(((ax1 * 400) + (k_outer * 4)))]));
      T_dense[(0)] = (T_dense[(0)] + (in[(((k_outer * 4) + 1))] * placeholder1[((((ax1 * 400) + (k_outer * 4)) + 1))]));
      T_dense[(0)] = (T_dense[(0)] + (in[(((k_outer * 4) + 2))] * placeholder1[((((ax1 * 400) + (k_outer * 4)) + 2))]));
      T_dense[(0)] = (T_dense[(0)] + (in[(((k_outer * 4) + 3))] * placeholder1[((((ax1 * 400) + (k_outer * 4)) + 3))]));
    }
...
__kernel void fused_nn_dense_relu_kernel0(__global float* restrict placeholder1, __global float* restrict placeholder2) {
  ...
  for (int ax1 = 0; ax1 < 84; ++ax1) {
    float T_dense[1];
    T_dense[(0)] = 0.000000e+00f;
    for (int k_outer = 0; k_outer < 30; ++k_outer) {
      T_dense[(0)] = (T_dense[(0)] + (in[((k_outer * 4))] * placeholder1[(((ax1 * 120) + (k_outer * 4)))]));
      T_dense[(0)] = (T_dense[(0)] + (in[(((k_outer * 4) + 1))] * placeholder1[((((ax1 * 120) + (k_outer * 4)) + 1))]));
      T_dense[(0)] = (T_dense[(0)] + (in[(((k_outer * 4) + 2))] * placeholder1[((((ax1 * 120) + (k_outer * 4)) + 2))]));
      T_dense[(0)] = (T_dense[(0)] + (in[(((k_outer * 4) + 3))] * placeholder1[((((ax1 * 120) + (k_outer * 4)) + 3))]));
    }
    //T_relu[(ax1)] = max((T_dense[(0)] + placeholder2[(ax1)]), 0.000000e+00f);
